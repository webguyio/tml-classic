...
<div class="tml tml-lostpassword" id="tml-classic<?php $template->the_instance(); ?>">
	...
	<form name="lostpasswordform" id="lostpasswordform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'lostpassword', 'login_post' ); ?>" method="post">
		<p class="tml-user-login-wrap">
			...
			if ( 'email' == $tml->get_option( 'login_type' ) ) {
		...
		<p class="tml-submit-wrap">
			<input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Get New Password', 'tml-classic' ); ?>">
