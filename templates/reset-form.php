...
<div class="tml tml-resetpass" id="tml-classic<?php $template->the_instance(); ?>">
	...
	<form name="resetpassform" id="resetpassform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'resetpass', 'login_post' ); ?>" method="post" autocomplete="off">
		...
		<div class="user-pass1-wrap">
			<p>
				<label for="pass1"><?php esc_html_e( 'New password', 'tml-classic' ); ?></label>
			</p>
			...
			<div class="wp-pwd">
				...
				<div id="pass-strength-result" class="hide-if-no-js" aria-live="polite"><?php esc_html_e( 'Strength indicator', 'tml-classic' ); ?></div>
			</div>
			<div class="pw-weak">
				<label>
		...
		<p class="user-pass2-wrap">
			<label for="pass2"><?php esc_html_e( 'Confirm new password', 'tml-classic' ); ?></label>
		...
		<p class="tml-submit-wrap">
			<input type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Reset Password', 'tml-classic' ); ?>">
